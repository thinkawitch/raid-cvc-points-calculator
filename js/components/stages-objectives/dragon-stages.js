...
export default function beatDragonStages() {
    ...
    return html`
        ...
        <${NumberInput} id="f-dragon-stage-hard-1-9" name="stage_hard_1_9" label="hard 1-9" value=${local.stage_hard_1_9} update=${setNewValue} />
        <${NumberInput} id="f-dragon-stage-hard-10" name="stage_hard_10" label="hard 10" value=${local.stage_hard_10} update=${setNewValue} />
    `;
}
